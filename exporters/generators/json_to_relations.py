...
# """
# json_to_relations.py
# Archivo puente: delega la generación de relaciones a /relaciones/builder.py
# y mantiene utilidades globales como to_camel() para compatibilidad.
# """

# import re
# from exporters.generators.relaciones.builder import build_relations
# from exporters.generators.relaciones.helpers import to_camel

# def to_camel(name: str) -> str:
#     """
#     Convierte nombres a camelCase:
#     Ejemplo: UnidadMedida → unidadMedida, unidad_medida → unidadMedida
#     """
#     if not name:
#         return name
#     parts = name.replace("-", "_").split("_")
...
# __all__ = ["build_relations", "to_camel"]




#exporters/generators/json_to_relations.py
"""
json_to_relations.py
Archivo puente: delega la generación de relaciones a /relaciones/builder.py
y mantiene utilidades globales como to_camel() para compatibilidad.
